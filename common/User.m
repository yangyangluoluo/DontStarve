...
- (NSString *)getPortait{
    return [self.accountDefaults objectForKey:@"portait"];
}

- (void )savePortait:(NSString *)portait{
    [self.accountDefaults setObject:portait forKey:@"portait"];
}
...
- (void )clearUserInformation{
    ...
    [self.accountDefaults setObject:nil forKey:@"portait"];
}
