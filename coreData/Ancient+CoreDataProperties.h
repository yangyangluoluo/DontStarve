...
@interface Ancient (CoreDataProperties)

@property (nullable, nonatomic, retain) NSNumber *ancient_id;
...
@interface Ancient (CoreDataGeneratedAccessors)
