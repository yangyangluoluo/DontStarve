...
@interface Survival (CoreDataProperties)

@property (nullable, nonatomic, retain) NSNumber *survival_id;
@property (nullable, nonatomic, retain) NSString *name;
@property (nullable, nonatomic, retain) NSString *technology;
@property (nullable, nonatomic, retain) NSString *useNum;
@property (nullable, nonatomic, retain) NSString *stackNum;
...
@interface Survival (CoreDataGeneratedAccessors)
