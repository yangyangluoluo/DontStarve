...
@interface Science (CoreDataProperties)

@property (nullable, nonatomic, retain) NSNumber *science_id;
...
@interface Science (CoreDataGeneratedAccessors)
